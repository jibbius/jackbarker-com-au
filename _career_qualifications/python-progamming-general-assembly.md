...
abbreviation: Python Programming
slug: python-programming-general-assembly
summary: "40-hour intensive Python programming certification demonstrating full-stack web development capabilities. Completed capstone project featuring Flask web framework, SQLAlchemy database integration, and RESTful API development. Skills include data manipulation, process automation, and modern software engineering practices with immediate business application potential."
---
...
*View the live project: [Flask Tic-Tac-Toe](https://jibbius.pythonanywhere.com/)*
